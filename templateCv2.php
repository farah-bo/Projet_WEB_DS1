...
<body>
 ...
 <a href="telecharger_cv2.php" class="btn-download" download>Télécharger CV en PDF</a>
...
?>
    <main id="cvContent" >
       <header>
                ...
                <div class="des">
                <h3><?php echo $cv->getNom();?> <?php echo $cv->getLnom();?></h3>
            </div>
            <div class="right">
                <p style="color: #4f3208;" ><img src="data:image/png;base64,<?php echo base64_encode(file_get_contents('mail.png')); ?>" class="info"><?php echo $cv->getMail(); ?></p>
                <p style="color: #4f3208;"><img src="data:image/png;base64,<?php echo base64_encode(file_get_contents('maps.png')); ?>" class="info"><?php echo $cv->getAdr() . ', ' . $cv->getCp() . ' ' . $cv->getCity(); ?></p>
                <p style="color: #4f3208;"><img src="data:image/png;base64,<?php echo base64_encode(file_get_contents('tele.png')); ?>" class="info"><?php echo $cv->getPhone(); ?></p>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.3.2/jspdf.debug.js"></script>
     ...
     <script>
             ...
             function downloadPDF() {
                 // Obtenir le contenu HTML de la section de CV
                 var cvContent = document.getElementById('cvContent').innerHTML;

                 // Créer un nouveau document PDF
                 var doc = new jsPDF();

                 // Ajouter le contenu HTML converti en PDF
                 doc.fromHTML(cvContent, 15, 15);

                 // Télécharger le PDF avec le nom 'cv.pdf'
                 doc.save('cv.pdf');
             }
         </script>
    <?php
